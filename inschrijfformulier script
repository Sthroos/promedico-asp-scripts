...
(function() {
    ...
    function isPatientFormPage() {
        ...
        // Only show on patient.m page (the new patient registration page)
        return url.includes('admin.onderhoud.patienten');
    }
    ...
    function getTargetDocument() {
        ...
        if (window.location.href.includes('admin.onderhoud.patienten')) {
            console.log('✓ We are inside a patient form page - using current document');
            return document;
        }
        ...
        if (iframe) {
            ...
            console.log('❌ Iframe not found - using current document');
        }
    ...
    // Create UI button
    function createUI() {
        // Only create button if we're on the patient form page
        if (!isPatientFormPage()) {
            console.log('Not on patient form page - button not created');
            return;
        }
        ...
        button.onclick = function(e) {
            ...
            if (text) {
                ...
                // Automatically clear the data after filling
                console.log('Auto-clearing saved data after form fill');
            }
            return false;
        };
